...
sleep 0.5
echo $(date +%Y_%m_%d-%H:%M:%S)
time $HOME/projects/gearshifft-gnu-wc/bin/gearshifft_fftwwrappers -e $size -r */double/*/*_Real -v -o "$HOME/projects/$SLURM_JOBID/$size/haswell_wc.csv" --rigor estimate
sleep 0.5
